  ...
  <div class="hero-caption">
    <div class="container fg-white h-100">
      <div class="row justify-content-center align-items-center text-center h-100">
        <div class="col-lg-6">
          <h3 class="mb-4 fw-medium">Kontak Alamat</h3>
    ...
    <div class="container">
      <div class="row justify-content-center">
          ...
          <div class="card-page">
            <div class="row row-beam-md">
              <div class="col-md-4 text-center py-3 py-md-2">
                ...
                <p class="fg-dark fw-medium fs-vlarge">Lokasi</p>
                <p class="mb-0">Jl. Raya Dieng-Batur, RT006/RW004<br>Desa Pasurenan, Kec. Batur, Kab. Banjarnegara, Jawa Tengah - Indonesia</p>
              </div>
              <div class="col-md-4 text-center py-3 py-md-2">
                <i class="mai-call-outline h3"></i>
                <p class="fg-dark fw-medium fs-vlarge">Whatsapp</p>
                <p class="mb-1">+62 852-0138-5401</p>
                <p class="mb-0">+62 812-2550-1034</p>
              </div>
              <div class="col-md-4 text-center py-3 py-md-2">
                <i class="mai-mail-open-outline h3"></i>
                <p class="fg-dark fw-medium fs-vlarge">Email</p>
                <p class="mb-1">nunungumk@gmail.com</p>
                <p class="mb-0">rohmiiumk@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-5 my-3 wow fadeInUp">
          <div class="card-page">
            <h3 class="fw-normal">Konsultasikan Asmaramu pada ahlinya !</h3>
            <form method="POST" class="mt-3">
              ...
              <div class="form-group">
                <label for="address" class="fw-medium fg-grey">Alamat</label>
                <input type="text" class="form-control" id="address">
              </div>

              <div class="form-group">
                <label for="phone" class="fw-medium fg-grey">Nomor Telp/Whatapps (optional)</label>
              ...
              <p>*Pesan tanpa identitas yang jelas akan kami abaikan.</p>
    
              <div class="form-group mt-4">
                <a href="https://www.whatsapp.com/catalog/6285201385401/" class="btn btn-primary">Kirim Pesan</a>
              </div>
            </form>
          </div>
        </div>
        ...
        <form method="POST">
          <div class="input-group">
            ...
            <div class="input-group-append">
             <a href="https://www.whatsapp.com/catalog/6285201385401/" class="btn btn-primary">Kirim</a>
            </div>
          </div>
        </form>
