...
<html lang="en">
    ...
    <body class=sb-nav-fixed>
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="galeri.php">Galeri</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h2 class="mt-4">Menu Data Galeri</h2>
                        <div class="card mb-4">
                            <div class="card-header">
                                <!-- Tombol tambah Galeri -->
                                <a href="tambahgaleri.php" class="btn btn-primary">Tambah Data Galeri</a>
                            </div>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="auto" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <td><?= $x;  ?></td>
												...
												<td><img src="../gambar/galeri/<?php echo $row["gambar_album"];?>" width="60" height="60"></td>
												<td><?= $row["deskripsi_album"]; ?></td>
												<td>
                                                    <a href="hapusgaleri.php?id=<?= $row["idalbum"]; ?>" class="btn btn-danger" onclick=" return confirm('Apakah Anda Yakin Untuk Menghapus Data?')";><i class='fa fa-trash'></i></a>
													<a href="ubahgaleri.php?id=<?= $row["idalbum"]; ?>" class="btn btn-warning" onclick=" return confirm('Apakah Anda Yakin Untuk Mengubah Data?')";><i class='fa fa-cog'></i></a>
                                                </td>
                                            </tr>
                                            <?php $x++; ?>
											<?php endforeach; ?>
