            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h2 class="mt-4">Menu Tambah Data Produk</h2>
                        <div class="card mb-4">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="container p-3 my-3 border">
                                    ...
                                    <input type="number" name="harga_produk" placeholder="Harga Produk" class="form-control" required>
                                    <label for="usr">Deskripsi:</label>
                                    <input type="text" name="deskripsi_produk" placeholder="Deskripsi Produk" class="form-control" required>
                                        <br><br>
