...
<html lang="en">
    ...
    <meta charset="utf-8" />
        ...
        <title>Barang Keluar - Transaksi</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h2 class="mt-4">Menu Data Barang Terjual</h2>
                        <div class="card mb-4">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a href="exportbarangkeluar.php" class="btn btn-success ml-2">Export</a>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            if(isset($_POST['filter'])){
                                                ...
                                                if($mulai!=NULL || $selesai!=NULL){
                                                    $brg=mysqli_query($conn,"SELECT * FROM keluar k, barang b where k.idbarang=b.idbarang
                                                     and tanggal_keluar BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY) ORDER BY tanggal_keluar DESC");
                                                }
                                                else{
                                                    $brg=mysqli_query($conn,"SELECT * FROM keluar k, barang b where k.idbarang=b.idbarang ORDER BY tanggal_keluar DESC");
                                                }
                                            }
                                            else{
                                                $brg=mysqli_query($conn,"SELECT * FROM keluar k, barang b where k.idbarang=b.idbarang ORDER BY tanggal_keluar DESC");
											...
											while($b=mysqli_fetch_array($brg)){
												...
												<tr>
													<td><?php echo $no++ ?></td>
													<td><?php $tanggals=$b['tanggal_keluar']; echo date("d-M-Y", strtotime($tanggals)) ?></td>
													<td><?php echo $b['namabarang'] ?></td>
													<td><?php echo $b['deskripsi'] ?></td>
													<td><?php echo number_format($b['jumlah']) ?></td>
													<td><strong><a href="viewpesanan.php?orderid=<?php echo $b['penerima'] ?>">#<?php echo $b['penerima'] ?></a></strong></td>
												</tr>		
												<?php 
											}
											?>
