...
<html lang="en">
    ...
    <meta charset="utf-8" />
        ...
        <title>Stok Barang - Transaksi Data</title>
                    ...
                    ?>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <button data-toggle="modal" data-target="#tambahbarang" type="button" class="btn btn-info mr-2">Tambah Produk Baru</button>
                                <a href="exportbarang.php" class="btn btn-success">Export</a>
                                <br>
                            </div>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="auto" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <td><?= $x++;  ?></td>
												...
												<td>
                                                    <a href="hapusbarang.php?id=<?= $data["idbarang"]; ?>" class="btn btn-danger" onclick=" return confirm('Apakah Anda Yakin Untuk Menghapus <?= $data['namabarang']?> ?')";><i class='fa fa-trash'></i></a>
													<button data-toggle="modal" data-target="#editbarang<?= $idbarang; ?>" type="button" class="btn btn-warning"><i class='fa fa-cog'></i></button>
                                                </td>
                                                <!-- modal input -->
                                                    <div id="editbarang<?= $idbarang; ?>" class="modal fade">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post">
                                                                        <div class="form-group">
                                                                            <label>Nama</label>
                                                                            <input name="namabarang" type="text" class="form-control" value="<?= $namabarang; ?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label>Deskripsi</label>
                                                                            <input name="deskripsibarang" type="text" class="form-control" value="<?= $deskripsi; ?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label>Harga</label>
                                                                            <input name="harga" type="number" min="0" class="form-control" value="<?= $harga; ?>">
                                                                        </div>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <input name ="editbarang" type="submit" class="btn btn-primary" value="Simpan">
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input name="namabarang" type="text" class="form-control" placeholder="Nama Barang" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Deskripsi</label>
                                                <input name="deskripsibarang" type="text" class="form-control" placeholder="Jenis / Deskripsi Barang">
                                            </div>
                                            <div class="form-group">
                                                <label>Stock</label>
                                                <input name="stok" type="number" min="0" class="form-control" placeholder="Qty">
                                            </div>
                                            <div class="form-group">
                                                <label>Harga</label>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                                            <input name ="tambahbarang" type="submit" class="btn btn-primary" value="Simpan">
                                        </div>
                                    </form>
                                </div>
                            </div>
