        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    ?>
                        <h2 class="mt-4">Menu Tambah Data Galeri</h2>
                        <div class="card mb-4">
                            <div class="card-header">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="container p-3 my-3 border">
                                    <label for="usr">Nama:</label>
                                    <input type="text" name="nama_album" placeholder="Nama Galeri" class="form-control" required>
                                        <br>
                                    <label for="usr">Gambar:</label>
                                    <input type="file" name="gambar_album" class="form-control" required>
                                        <br>
                                    <label for="usr">Deskripsi:</label>
                                    <input type="text" name="deskripsi_album" placeholder="Deskripsi Galeri" class="form-control" required>
                                        <br>
